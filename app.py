...
def generate_game9(story_name, file=None):
   ...
   # true_word=words_arr[rand_ct[0]]#right answer
    ...
    return  render_template('game9_template.html',t_answer=true_word,question0=missing_sent,question1=true_match[1],fake_answer_0=bad_words[0],fake_answer_1=bad_words[1],fake_answer_2=bad_words[2],fake_answer_3=bad_words[3],name=story_name)
...
def generate_game10(story_name, file=None):
   ...
   # true_word=words_arr[rand_ct[0]]#right answer
    ...
    return  render_template('game10_template.html',t_answer=true_word,question0=missing_sent,question1=true_match[1],fake_answer_0=bad_words[0],fake_answer_1=bad_words[1],fake_answer_2=bad_words[2],fake_answer_3=bad_words[3],name=story_name)
...
def generate_game11(story_name, file=None):
   ...
   # true_word=words_arr[rand_ct[0]]#right answer
    ...
    return  render_template('game11_template.html',t_answer0=true_word[0],t_answer1=true_word[1],question0=missing_sent,question1=true_match[1],fake_answer_0=bad_words[0],fake_answer_1=bad_words[1],fake_answer_2=bad_words[2],fake_answer_3=bad_words[3],name=story_name)
...
def generate_game12(story_name, file=None):
   ...
   # true_word=words_arr[rand_ct[0]]#right answer
    ...
    return  render_template('game12_template.html',t_answer=true_word,question0=missing_sent,question1=true_match[1],fake_answer_0=bad_words[0],fake_answer_1=bad_words[1],fake_answer_2=bad_words[2],fake_answer_3=bad_words[3],name=story_name)
