...
$MsgToShow = "notSetYet";
$PythonFailureReturnMsgs = array("TaggedFileFailed", "FailedToExtractExtResFile", "FailToSegmentizeCreateResources", "FailToSegmentizeTagRawText",
            "MergeLanguageResourcesFailed", "FirstCompileStepFailed", "FirstCompileStepWithWarningDone",
            "InstallPrvAudioFailed", "InstallZipfileFailed", "InstallNolLDTAudioFailed", "CreatePagesFailed", "CreatePagesForSnFailed",
    ...
    <form method="POST" id="configFileForm" enctype='multipart/form-data'>
        ...
        <div class="table" id="firstStep">
            ...
            <div id="AutomaticTagger" class="table">
                ...
                <?php if(!empty($contentObj->RawTextFileName)){
                    ...
                    echo '<div class="tr" id="OnServerRawTextTR" style="display: none">
                        <div class="tdTitle">
            ...
            <div id="ComplementaryDiv" class="table">
                <div id="ComplementaryDiv_Sec1" class="table">
                    ...
                    <div class="tr" id="LdtDeactivateStatusTR">
                    ...
                    <div class="tr" id="WordAudioTR">
                        <div class="tdTitle">Assign recording voice for words:</div>
                        <div class="tdInput">
                            <?php echo $drp_Word; ?>
                        </div>
                    </div>
                    <div class="tr" id="SegmentAudioTR">
            ...
            <?php if(!isset($_REQUEST["mode"]) || $_REQUEST["mode"] != 'readOnly' ) { ?>
        ...
        <div class="table" id="secondStep">
            <div id="TranslationAndRecordingDiv" class="table">
                ...
                <h3>Recording</h3>
                <div id="RecordingDiv" class="tableAccordion" style="height: 40px">
                    <div class="table">
                        <div class="tr">
                            <div class="tdTXT" >
